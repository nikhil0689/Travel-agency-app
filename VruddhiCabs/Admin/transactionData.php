...
<div class="page_content">
		...
		<?php 
			...
			if($connection){
				...
				if($numResults == 0){
					...
					redirect_to("searchByDates.php");
				}
				
		?>	
		<table class="table_style">
			<tr><th>ID</th><th>Name</th><th>Contact</th><th>Company</th><th>Date of Travel</th><th>Driver Name</th><th>Vehicle No.</th>
	...
	<form action="report.php" id="company_data" method="post">
