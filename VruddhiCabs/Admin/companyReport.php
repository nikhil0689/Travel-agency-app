...
<html>
	...
	<div>
		...
		<hr>
		<h3 style="text-align: center; margin-top: -10px;">Invoice Report</h3>
		<?php 
			global $connection;
			if($connection){
		...
		<div class="report_box">
			<h3>For <?php echo $company;?></h3>
			<table cellpadding="0" cellspacing="0">
				<tr class="heading"><td>Invoice ID</td><td>Name</td><td>Employee ID</td><td>Date of Travel</td><td>Driver Name</td><td>Vehicle No.</td>
		...
		<?php    
			...
			$body = iconv("UTF-8","UTF-8//IGNORE",$body);
		   	...
		   	$filename = $company." Transaction Report.pdf";
